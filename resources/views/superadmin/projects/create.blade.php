<x-panel.dash>
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="dash-title">Create Project</h1>
            </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="start_date"
                                            placeholder="Eg: Mapping for Pangolin" value="{{ old('start_date') }}"
                                            name="start_date">
                                        @error('start_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="end_date"
                                            placeholder="Eg: Mapping for Pangolin" value="{{ old('end_date') }}"
                                            name="end_date">
                                        @error('end_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="status">
                                            <option class="text-muted">---Select project state---</option>

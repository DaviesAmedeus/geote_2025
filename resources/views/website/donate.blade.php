...
It directly supports GeoTE’s mission to make the world a better place through open geospatial data, technology, and innovation. Your support helps us maintain and expand our open datasets, pilot new geospatial technologies, and empower communities to sustainably manage natural resources.</p>
          ...
          <div class="col-lg-6 img-bg" style="background-image: url({{ asset('assets/img/website/helpusgrow.jpeg') }});" data-aos="zoom-in" data-aos-delay="100"></div>
        </div>
